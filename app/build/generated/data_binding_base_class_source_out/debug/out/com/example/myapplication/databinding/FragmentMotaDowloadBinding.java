...
public final class FragmentMotaDowloadBinding implements ViewBinding {
  ...
  private FragmentMotaDowloadBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgMoTa,
      @NonNull TextView txtGiaMota, @NonNull TextView txtMoTa, @NonNull TextView txtMotaTenfood) {
  ...
  public static FragmentMotaDowloadBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMotaDowloadBinding((LinearLayout) rootView, imgMoTa, txtGiaMota, txtMoTa,
          txtMotaTenfood);
    }
